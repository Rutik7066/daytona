...
func (suite *GitnessClientTestSuite) SetupSuite() {
	...
	token := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTkyMTIyMjAsImlhdCI6MTcxODYwNzQyMCwiaXNzIjoiR2l0bmVzcyIsInBpZCI6MywidGtuIjp7InR5cCI6InBhdCIsImlkIjoyfX0.eQQBjesNPZPC2cZV0Qx6hLuZ1iVT3rRFWMBjXMT1eZY"
